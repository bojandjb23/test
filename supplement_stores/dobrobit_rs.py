"""Scraper for dobrobit.rs - Health supplements, vitamins (likely WooCommerce)."""
...
class DobrobitScraper(BaseStoreScraper):
    ...
    CATEGORY_URLS = [
        ...
        "/kategorija/vitamini/",
        "/kategorija/minerali/",
        "/kategorija/probiotici/",
        "/kategorija/imunitet/",
        "/kategorija/zglobovi/",
        "/kategorija/zdravlje-srca/",
    ]
    ...
    def parse_product_card(self, card: Tag) -> Optional[Dict[str, Any]]:
        """Parse a WooCommerce product card from Dobrobit."""
